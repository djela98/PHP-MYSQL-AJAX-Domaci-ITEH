<table class="table table-bordered" id="pretraga-rez">
    ...
    <tbody class="table-light">
        ...
        $upit = "select s.id, s.ime_prezime, s.jmbg, s.broj_indeksa, f.naziv, u.grad from student s join fakultet f on s.fakultet_id=f.id join univerzitet u on s.univerzitet_id=u.id order by " . $kolona . " " . $sort;
